...
const SkillLevelButton = ({ learnerId, currentSkillLevel }) => {
  ...
  return (
    <div className="mb-8">
      <p className="text-lg font-semibold">After clicking this button please logout and then login again to access particular skill level specific facilities
      </p>
...
{currentView === 'skillLevel' && (
  <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg">
    ...
    <p className="text-lg text-gray-700 mb-4 text-center">
      Update your skill level to reflect your current abilities and progress.
    </p>
